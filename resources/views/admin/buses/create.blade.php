...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">Add Bus</h2>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="name"
                                           id="name"
                                           placeholder="Bus Name" value="" required/>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                           name="mobile_no"
                                           id="mobile_no"
                                           placeholder="Bus Contact Number" value="" required type="text" maxlength="10"/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="tag_number"
                                           id="tag_number"
                                           placeholder="Bus Tag Number" value="" required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            <div class="col-12">
