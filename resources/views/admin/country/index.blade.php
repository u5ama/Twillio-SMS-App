...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.country') }}</h2>

            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('admin.country.create') }}" class="btn btn-primary  mr-2">
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap" id="data-table">
                            ...
                            <tr>
                                ...
                                <th>{{ config('languageString.country_code') }} </th>
...
@section('js')
<script>
    const sweetalert_title = "{{ config('languageString.country_destroy').'?' }}";
