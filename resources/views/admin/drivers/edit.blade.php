                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="name"
                                           id="name"
                                           placeholder="Driver Name" value="{{ $driver->name }}" required/>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                           name="mobile_no"
                                           id="mobile_no"
                                           placeholder="Driver Contact Number" value="{{ $driver->mobile_no }}" required type="text" maxlength="10"/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="tag_number"
                                           id="tag_number"
                                           placeholder="Driver Tag Number" value="{{ $driver->tag_number }}" required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="taxi_number"
                                           id="taxi_number"
                                           placeholder="Driver Taxi Number" value="{{ $driver->taxi_number }}" required/>
                                    <div class="help-block with-errors error"></div>
                                </div>
                            </div>
