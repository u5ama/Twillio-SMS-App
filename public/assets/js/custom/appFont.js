$(function () {
    ...
    const table = $('#data-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: APP_URL + '/app-font',
            type: 'GET',
        },
        columns: [
            {data: 'id', name: 'id'},
            {data: 'font_name', name: 'font_name'},
            {data: 'font_value', name: 'font_value'},
            {data: 'font_key', name: 'font_key'},
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success === true) {
                        ...
                        setTimeout(function () {
                            window.location.href = APP_URL + '/app-font'
                        }, 1000);
    ...
    function changeStatus(value_id, status) {
        $.ajax({
            type: 'GET',
            url: APP_URL + '/appFontChangeStatus/' + value_id + '/' + status,
            success: function (data) {
                successToast(data.message, 'success');
                table.draw()
                loaderHide();
