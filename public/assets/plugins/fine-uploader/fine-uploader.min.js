    ...
    !function () {
        ...
        qq.basePublicApi = {
            ...
            _addCannedFile: function (e) {
                ...
                var n, i = this, o = e.accept || this._options.validation.acceptFiles,
                ...
                if (this._options.camera.ios && qq.ios()) {
                    var e = this._options.camera.button, t = e ? this._getButtonId(e) : this._defaultButtonId,
                        n = this._options;
                ...
                var i = this, o = qq.getUniqueId(), r = -1, a = qq.getFilename(e), s = e.blob || e,
                ...
                var o, r, a = this._options.messages[e], s = [], u = [].concat(t), l = u[0], c = this._getButtonId(n),
                ...
                var n = this, i = function () {
                    ...
                    }(), o = t.name, r = t.size, a = this._getButtonId(e.file), s = this._getValidationBase(a),
                    u = new qq.Promise;
        ...
        var n, i, o, r = this, a = !1, s = !1, u = {
            ...
            isInProgress: function (e) {
                ...
                var t = u.getSize(e), n = u.getName(e), r = l.nextPart(e), a = o._getChunkData(e, r),
                    d = o._getFileState(e), h = d.attemptingResume, q = d.chunking.inProgress || [];
                    ...
                    u.onUploadChunk(e, n, o._getChunkDataForCallback(a)).then(function (n) {
                        if (u.isInProgress(e)) {
                            ...
                            o.uploadChunk(s).then(function (t, n) {
                                ...
                                var a = o._getFileState(e).chunking.inProgress || [], s = p.normalizeResponse(t, !0),
                                    u = qq.indexOf(a, r);
        ...
        var r = e.options, a = this, s = e.proxy, u = qq.getUniqueId(), l = {}, c = {}, d = {}, p = r.isCors,
            h = r.inputName, q = s.getUuid, f = s.log, m = new qq.WindowReceiveMessage({log: f});
        qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function (e) {
            ...
            getInput: function (e) {
                ...
                var t = e.method, n = e.endpoint, i = e.params, o = e.paramsInBody, r = e.targetName,
                    a = qq.toElement("<form method='" + t + "' enctype='multipart/form-data'></form>"), s = n;
        ...
        var n = this, i = e.options.namespace, o = e.proxy, r = e.options.chunking, a = function (e) {
            ...
            }, s = e.options.resume, u = r && e.options.chunking.enabled && qq.supportedFeatures.chunking,
            l = s && e.options.resume.enabled && u && qq.supportedFeatures.resume, c = o.getName, d = o.getSize,
            p = o.getUuid, h = o.getEndpoint, q = o.getDataByUuid, f = o.onUuidChanged, m = o.onProgress, g = o.log,
        ...
        qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function (e) {
            ...
            clearCachedChunk: function (e, t) {
                ...
                var i = a(e), o = d(e), r = n.getFile(e), s = i * t, u = s + i >= o ? o : s + i,
                    l = n._getTotalChunks(e), c = this._getFileState(e).temp.cachedChunks,
                ...
                var t = c(e), n = d(e), o = a(e), r = h(e), u = s.customKeys(e),
                ...
                var o = n._getXhr(e, t), r = c(e), a = {
                    simple: function (t, n) {
                        ...
                        var s = n._getFileState(e).temp.chunkProgress, u = n._getFileState(e).loaded, l = o, c = a,
                            p = d(e), h = l - (c - i), q = u;
        ...
        function o(n, o, s, u, l) {
            var c, d = n.naturalWidth, p = n.naturalHeight, h = u.width, q = u.height, f = s.getContext("2d"),
                m = new qq.Promise;
            return f.save(), u.resize ? r({
                ...
                e(n) && (d /= 2, p /= 2);
                var i, o, r, a = 1024, s = document.createElement("canvas"), u = l ? t(n, d, p) : 1,
                    c = Math.ceil(a * h / d), m = Math.ceil(a * q / p / u), g = 0, _ = 0;
        ...
        function r(e) {
            var t = e.blob, n = e.image, i = e.imageHeight, o = e.imageWidth, r = e.orientation, s = new qq.Promise,
                u = e.resize, l = document.createElement("canvas"), c = l.getContext("2d"), d = e.canvas,
                p = e.targetHeight, h = e.targetWidth;
        ...
        s.prototype.render = function (e, t) {
            t = t || {};
            var i, r = this, a = this.srcImage.naturalWidth, s = this.srcImage.naturalHeight, u = t.width, l = t.height,
                c = t.maxWidth, d = t.maxHeight, p = !this.blob || "image/jpeg" === this.blob.type,
        ...
        function c(t, n, i) {
            var o = new qq.Promise, r = new qq.Identify(t, e), a = i.maxSize, s = null == i.orient || i.orient,
                u = function () {
        ...
        qq.extend(this, {
            isPreviewable: function () {
                ...
                var n = e.type, i = qq.indexOf(Object.keys(this.PREVIEWABLE_MIME_TYPES), n) >= 0, o = !1,
        ...
        function o(e, t) {
            ...
            return qq.each(e, function (e, i) {
                if (i > 0) {
                    var o = /(max|min)(Width|Height)/.exec(e), r = o[2].charAt(0).toLowerCase() + o[2].slice(1),
                        a = t[r];
                    switch (o[1]) {
                        case"min":
                            if (a < i) return n = e, !1;
        ...
        "use strict";
        var n = e.customResizer, i = e.sendOriginal, o = e.orient, r = e.defaultType, a = e.defaultQuality / 100,
            s = e.failureText, u = e.includeExif, l = this._getSortedSizes(e.sizes);
        qq.extend(this, {
            enabled: qq.supportedFeatures.scaling && l.length > 0, getFileRecords: function (e, c, d) {
                ...
                var u = this, l = (e.qqButtonId || e.blob && e.blob.qqButtonId, []), c = null, d = s.addFileToHandler,
                    p = s.uploadData, h = s.paramsStore, q = qq.getUniqueId();
        ...
        scaleImage: function (e, t, n) {
            ...
            var i = new qq.Promise, o = n.log, r = n.getFile(e), a = n.uploadData.retrieve({id: e}), s = a && a.name,
                u = a && a.uuid, l = {
            ...
            "use strict";
            var n = e.lastIndexOf("."), i = t.type || "image/png", o = t.refType, r = "", a = qq.getExtension(e),
                s = "";
            ...
            "use strict";
            var n = this, i = e.customResizeFunction, o = e.log, r = e.maxSize, a = e.orient, s = e.type, u = e.quality,
                l = e.failedText, c = e.includeExif && "image/jpeg" === t.type && "image/jpeg" === s,
                d = new qq.Promise, p = new qq.ImageGenerator(o), h = document.createElement("canvas");
        ...
        return e.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e.encode64 = function (e) {
            ...
            var n = e.replace("data:image/jpeg;base64,", ""), i = this.decode64(n), o = i.indexOf(255, 3),
                r = i.slice(0, o), a = i.slice(o), s = r;
        ...
        function i(t, n) {
            var i = e.paramsStore.get(t), s = "get" === e.method.toLowerCase() ? "GET" : "POST",
        ...
        "use strict";
        var n = this, i = t.getName, o = t.getSize, r = t.getUuid, a = t.log, s = e.forceMultipart || e.paramsInBody,
            u = function (t, n, r) {
                var a = o(t), u = i(t);
                ...
                var n, a = t.fileOrBlob, u = t.id, l = t.xhr, c = t.xhrOverrides || {}, d = t.customParams || {},
                    p = t.params || {}, h = c.params || {}, q = s ? new FormData : null, f = c.method || e.method,
                    m = c.endpoint || e.endpointStore.get(u), g = i(u), _ = o(u);
        ...
        qq.extend(this, {
            uploadChunk: function (t) {
                var i, o, r, a = t.id, s = t.chunkIdx, l = t.overrides || {}, d = t.resuming, p = n._getChunkData(a, s),
                    h = n._createXhr(a, s), q = {};
        ...
        qq.uiPublicApi = {
            ...
            _getButton: function (e) {
                ...
                var r = this._parent.prototype._onComplete.apply(this, arguments), a = this._templating,
                    s = a.getFileContainer(e), u = this;
                ...
                var i, o = this.getName(e), r = this._options.deleteFile.confirmMessage.replace(/\{filename\}/g, o),
                    a = (this.getUuid(e), arguments), s = this;
        ...
        "use strict";
        var t, n, i, o, r, a, s, u, l = {content: document.createDocumentFragment(), map: {}}, c = !1, d = 0, p = !1,
            h = [], q = -1, f = {
                log: null,
                ...
                var e = f.placeholders.thumbnailNotAvailable, n = f.placeholders.waitingForThumbnail,
                    i = {maxSize: q, scale: u};
                ...
                var t = e.id, n = e.optFileOrBlob, i = n && n.qqThumbnailId, o = O(t),
                    r = {customResizeFunction: e.customResizeFunction, maxSize: q, orient: !0, scale: !0};
                ...
                var t = e.id, n = e.thumbnailUrl, i = e.showWaitingImg, o = O(t),
                    r = {customResizeFunction: e.customResizeFunction, scale: u, maxSize: q};
                if (o) if (n) {
        ...
        qq.extend(f, e), t = f.log, qq.supportedFeatures.imagePreviews || (f.limits.timeBetweenThumbs = 0, f.limits.maxThumbs = 0), r = f.containerEl, s = void 0 !== f.imageGenerator, o = M(), b(), qq.extend(this, {
            render: function () {
                ...
                var i = C(e), o = N(i, m.dialogMessage), r = i.getElementsByTagName("INPUT")[0],
                    a = N(i, m.dialogCancelButton), s = N(i, m.dialogOkButton), u = new qq.Promise, l = function () {
