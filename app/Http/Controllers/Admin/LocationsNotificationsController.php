...
class LocationsNotificationsController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if($request->ajax()){
            //DB::enableQueryLog();
            $sms = SMSLogs::where('type', 'station')->get();
            // dd(DB::getQueryLog());
        ...
        return view('admin.locations_notifications.index');
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Location Log Deleted']);
    }
}
